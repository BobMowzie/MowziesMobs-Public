...
public class ParticleHandler {
    ...
    public static final RegistryObject<ParticleType<AdvancedParticleData>> MOON_FULL = register("moon_full", AdvancedParticleData.DESERIALIZER);
    public static final RegistryObject<ParticleType<AdvancedParticleData>> MOON_GIBBOUS = register("moon_gibbous", AdvancedParticleData.DESERIALIZER);
    public static final RegistryObject<ParticleType<AdvancedParticleData>> MOON_HALF = register("moon_half", AdvancedParticleData.DESERIALIZER);
    public static final RegistryObject<ParticleType<AdvancedParticleData>> MOON_CRESCENT = register("moon_crescent", AdvancedParticleData.DESERIALIZER);
    public static final RegistryObject<ParticleType<AdvancedParticleData>> MOON_NEW = register("moon_new", AdvancedParticleData.DESERIALIZER);
