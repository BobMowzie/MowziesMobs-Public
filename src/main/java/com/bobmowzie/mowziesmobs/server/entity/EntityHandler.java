...
public class EntityHandler {
    ...
    public static final RegistryObject<EntityType<EntityFoliaath>> FOLIAATH = REG.register("foliaath", () -> EntityType.Builder.of(EntityFoliaath::new, MobCategory.MONSTER).sized(0.5f, 2.5f).clientTrackingRange(8).build(new ResourceLocation(MowziesMobs.MODID, "foliaath").toString()));
    public static final RegistryObject<EntityType<EntityBabyFoliaath>> BABY_FOLIAATH = REG.register("baby_foliaath", () -> EntityType.Builder.of(EntityBabyFoliaath::new, MobCategory.MONSTER).sized(0.4f, 0.4f).clientTrackingRange(8).build(new ResourceLocation(MowziesMobs.MODID, "baby_foliaath").toString()));
    public static final RegistryObject<EntityType<EntityWroughtnaut>> WROUGHTNAUT = REG.register("ferrous_wroughtnaut", () -> EntityType.Builder.of(EntityWroughtnaut::new, MobCategory.MONSTER).sized(2.5f, 3.5f).clientTrackingRange(8).setUpdateInterval(1).build(new ResourceLocation(MowziesMobs.MODID, "ferrous_wroughtnaut").toString()));
    ...
    public static final RegistryObject<EntityType<EntityUmvuthanaFollowerToRaptor>> UMVUTHANA_FOLLOWER_TO_RAPTOR = REG.register("umvuthana_follower_raptor", () -> umvuthanaFollowerToRaptorBuilder().sized(MaskType.FEAR.entityWidth, MaskType.FEAR.entityHeight).clientTrackingRange(8).setUpdateInterval(1).build(new ResourceLocation(MowziesMobs.MODID, "umvuthana_follower_raptor").toString()));
    ...
    public static final RegistryObject<EntityType<EntityUmvuthanaCraneToPlayer>> UMVUTHANA_CRANE_TO_PLAYER = REG.register("umvuthana_crane_player", () -> umvuthanaCraneToPlayerBuilder().sized(MaskType.FAITH.entityWidth, MaskType.FAITH.entityHeight).clientTrackingRange(8).setUpdateInterval(1).build(new ResourceLocation(MowziesMobs.MODID, "umvuthana_crane_player").toString()));
    public static final RegistryObject<EntityType<EntityUmvuthanaMinion>> UMVUTHANA_MINION = REG.register("umvuthana", () -> EntityType.Builder.of(EntityUmvuthanaMinion::new, MobCategory.MONSTER).sized(MaskType.FEAR.entityWidth, MaskType.FEAR.entityHeight).clientTrackingRange(8).setUpdateInterval(1).build(new ResourceLocation(MowziesMobs.MODID, "umvuthana").toString()));
    public static final RegistryObject<EntityType<EntityUmvuthanaRaptor>> UMVUTHANA_RAPTOR = REG.register("umvuthana_raptor", () -> EntityType.Builder.of(EntityUmvuthanaRaptor::new, MobCategory.MONSTER).sized(MaskType.FURY.entityWidth, MaskType.FURY.entityHeight).clientTrackingRange(8).setUpdateInterval(1).build(new ResourceLocation(MowziesMobs.MODID, "umvuthana_raptor").toString()));
    public static final RegistryObject<EntityType<EntityUmvuthanaCrane>> UMVUTHANA_CRANE = REG.register("umvuthana_crane", () -> EntityType.Builder.of(EntityUmvuthanaCrane::new, MobCategory.MONSTER).sized(MaskType.FEAR.entityWidth, MaskType.FEAR.entityHeight).clientTrackingRange(8).setUpdateInterval(1).build(new ResourceLocation(MowziesMobs.MODID, "umvuthana_crane").toString()));
    public static final RegistryObject<EntityType<EntityUmvuthi>> UMVUTHI = REG.register("umvuthi", () -> EntityType.Builder.of(EntityUmvuthi::new, MobCategory.MONSTER).sized(1.5f, 3.2f).clientTrackingRange(10).setUpdateInterval(1).build(new ResourceLocation(MowziesMobs.MODID, "umvuthi").toString()));
    public static final RegistryObject<EntityType<EntityFrostmaw>> FROSTMAW = REG.register("frostmaw", () -> EntityType.Builder.of(EntityFrostmaw::new, MobCategory.MONSTER).sized(4f, 4f).clientTrackingRange(10).setUpdateInterval(1).build(new ResourceLocation(MowziesMobs.MODID, "frostmaw").toString()));
    public static final RegistryObject<EntityType<EntityGrottol>> GROTTOL = REG.register("grottol", () -> EntityType.Builder.of(EntityGrottol::new, MobCategory.MONSTER).sized(0.9F, 1.2F).clientTrackingRange(8).setUpdateInterval(1).build(new ResourceLocation(MowziesMobs.MODID, "grottol").toString()));
    ...
    public static final RegistryObject<EntityType<EntityElokosaFollowerToHowler>> ELOKOSA_FOLLOWER_TO_HOWLER = REG.register("elokosa_follower_howler", () -> elokosaFollowerToHowlerBuilder().sized(0.9F, 1.6F).clientTrackingRange(8).setUpdateInterval(1).build(new ResourceLocation(MowziesMobs.MODID, "elokosa_follower_howler").toString()));
    public static final RegistryObject<EntityType<EntityElokosaHowler>> ELOKOSA_HOWLER = REG.register("elokosa_howler", () -> EntityType.Builder.of(EntityElokosaHowler::new, MobCategory.MONSTER).sized(0.9F, 1.6F).clientTrackingRange(8).setUpdateInterval(1).build(new ResourceLocation(MowziesMobs.MODID, "elokosa_howler").toString()));
    ...
    public static final RegistryObject<EntityType<EntityRockSling>> ROCK_SLING = REG.register("rock_sling", () -> rockSlingBuilder().sized(0.5f, 0.5f).setUpdateInterval(1).build(new ResourceLocation(MowziesMobs.MODID, "rock_sling").toString()));
    ...
    public static final RegistryObject<EntityType<EntityPillar.EntityPillarSculptor>> PILLAR_SCULPTOR = REG.register("pillar_sculptor", () -> sculptorPillarBuilder().sized(1f, 1f).clientTrackingRange(8).setUpdateInterval(1).build(new ResourceLocation(MowziesMobs.MODID, "pillar_sculptor").toString()));
