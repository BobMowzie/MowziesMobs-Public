...
public class LootTableHandler {
    ...
    public static final ResourceLocation SCULPTOR_TEST = register("entities/sculptor_test");
    public static final ResourceLocation BLUFF = register("entities/bluff");
    public static final ResourceLocation ELOKOSA = register("entities/elokosa");
    ...
    public static RegistryObject<LootItemConditionType> ELOKOSA_NIGHT_FORM = registerCondition("night_form", new LootConditionElokosaNightForm.ConditionSerializer());
    public static RegistryObject<LootItemConditionType> MOON_PHASE = registerCondition("moon_phase", new LootConditionMoonPhase.ConditionSerializer());
